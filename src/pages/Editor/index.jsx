...
const Editor = () => {
  ...
  return (
    <>
      <header className="flex justify-between items-center p-3 pb-1 dark:bg-gray-800 dark:text-white">
        ...
        <div className="flex-grow px-2 ">
          ...
          <div className="flex items-center overflow-x-scroll text-sm space-x-1 ml-1 text-gray-600 dark:text-white">
        ...
        <Button
          ...
          className="bg-[#1A73E8] dark:bg-green-500 dark:text-text-white hover:bg-blue-500 hover:text-white !rounded-md md:inline-flex h-10 ml-4"
          rounded={false}
          block={false}
          iconOnly={false}
          ripple="light"
